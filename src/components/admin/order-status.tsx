    ...
    <div className="rounded-2xl border border-zinc-200 bg-white p-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        <select
          ...
          className="flex-1 rounded-xl border border-zinc-200 bg-white px-3 py-2.5 text-sm text-zinc-900 outline-none transition-colors focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20"
        >
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 rounded-xl bg-zinc-900 px-5 py-2.5 text-xs font-black uppercase tracking-wider text-white transition-colors hover:bg-amber-600 hover:text-zinc-950 disabled:opacity-50"
        >
