    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="mb-8 border-b border-zinc-200 pb-8">
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <h1 className="mt-1 text-3xl sm:text-5xl font-black text-zinc-900 uppercase tracking-tight">
              Your Saved Styles
            </h1>
          ...
          {savedProducts.length > 0 && (
            <button
              ...
              className="inline-flex shrink-0 items-center gap-1.5 rounded-xl border border-zinc-300 bg-white px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-zinc-600 transition-colors hover:border-rose-300 hover:text-rose-600"
            >
      ...
      {savedProducts.length === 0 ? (
        <div className="bg-white border border-zinc-200 rounded-2xl px-6 py-16 text-center">
          ...
          <p className="mt-2 text-zinc-500 text-sm sm:text-base max-w-sm mx-auto">
